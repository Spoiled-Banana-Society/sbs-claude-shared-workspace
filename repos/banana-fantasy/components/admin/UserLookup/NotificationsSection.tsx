 ...
 * (Resend's `email.delivered` / `email.bounced` / `email.complained`
 * events). Without this we'd only know "the provider accepted" — which
 * lies when delivery later bounces, gets spam-flagged, or hits a quota.
 */
