...
const seedPromos: Promo[] = [
  ...
  },
  {
    id: '11',
    type: 'first-purchase',
    title: 'First Deposit → WIN UP TO 40 FREE DRAFTS',
    description: 'Every $25 Deposited = 2 Free Spins · Deposit $25 → 2 Free Drafts GTD, up to 40 Free Drafts ($1,000 in Drafts)',
    ctaText: 'Buy Drafts',
    ctaLink: '/buy-drafts',
    backgroundColor: '#2a2a35',
    ...
    claimCount: 0,
    modalContent: {
      title: 'Every $25 Deposited = 2 Free Spins — win up to 40 Free Drafts ($1,000 in Drafts)',
      explanation:
        '• Every $25 you deposit = 2 Free Spins — no cap.\n• Deposit $25 → 2 Free Spins: 2 Free Drafts guaranteed — win up to 40 Free Drafts ($1,000 in Drafts).\n• Deposit $50 → 4 Free Spins: 4 Free Drafts guaranteed — up to 80 Free Drafts ($2,000 in Drafts).\n• Deposit $100 → 8 Free Spins: 8 Free Drafts guaranteed — up to 160 Free Drafts ($4,000 in Drafts).\n• One-time offer: your first deposit only.\n• Your Spins land right here after you deposit — claim and spin to collect your Drafts.',
    },
  },
  {
    id: '1',
