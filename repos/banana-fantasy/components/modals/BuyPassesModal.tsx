...
export function BuyPassesModal({
  ...
  const usdcSteps: VisibleStep[] = [
    { label: 'Confirm with your wallet', completeAtIdx: 1, helper: 'Check your wallet to approve. Your first approval sets a $1,000 USDC spending cap so future entries are 1-tap — no signing.' },
