...
const INFO_TOPICS: Record<string, { title: string; items: { q: string; a: string }[] }> = {
  ...
  hof: {
    ...
    items: [
      ...
      { q: 'How do I get into a HOF Draft?', a: 'Two ways. 1) The reveal: every paid draft has a shot — when your room fills to 10, the slot machine reveals your type, and every 100 drafts contains exactly 5 HOF. 2) The Banana Wheel: land on HOF and you win a guaranteed seat in a special HOF draft, free.' },
      { q: 'What happens when I win a HOF on the Banana Wheel?', a: 'You\'re seated in a special HOF draft instantly — you\'ll see it in your lobby right away. The draft starts automatically the moment 10 wheel winners have joined. It\'s a slow draft with 8 hours per pick (the clock pauses overnight), so there\'s plenty of time to make every pick.' },
      { q: 'Can I leave or sell a wheel-won HOF seat?', a: 'Your seat is locked — there\'s no leaving a special draft. But until the draft fills, you can sell the pass on the SBS Marketplace and the buyer takes your seat. It\'s the only draft pass that can ever be sold. Once the draft fills, the window closes and it\'s your draft.' },
      { q: 'Do special HOF drafts count toward promos?', a: 'No. Special wheel-won drafts are free drafts and never earn promos — no free spin for a Slot 10, and they don\'t count toward the 4-drafts-in-a-day promo.' },
    ],
  },
  jackpot: {
    title: 'Jackpot',
    items: [
      ...
      { q: 'How do I get into a Jackpot Draft?', a: 'Two ways. 1) The reveal: every paid draft has a shot — when your room fills to 10, the slot machine reveals your type, and every 100 drafts contains exactly 1 Jackpot. 2) The Banana Wheel: land on Jackpot and you win a guaranteed seat in a special Jackpot draft, free.' },
      { q: 'What happens when I win a Jackpot on the Banana Wheel?', a: 'You\'re seated in a special Jackpot draft instantly — you\'ll see it in your lobby right away. The draft starts automatically the moment 10 wheel winners have joined. It\'s a slow draft with 8 hours per pick (the clock pauses overnight), so there\'s plenty of time to make every pick.' },
      { q: 'Can I leave or sell a wheel-won Jackpot seat?', a: 'Your seat is locked — there\'s no leaving a special draft. But until the draft fills, you can sell the pass on the SBS Marketplace and the buyer takes your seat. It\'s the only draft pass that can ever be sold. Once the draft fills, the window closes and it\'s your draft.' },
      { q: 'Do special Jackpot drafts count toward promos?', a: 'No. Special wheel-won drafts are free drafts and never earn promos — no free spin for a Slot 10, and they don\'t count toward the 4-drafts-in-a-day promo.' },
