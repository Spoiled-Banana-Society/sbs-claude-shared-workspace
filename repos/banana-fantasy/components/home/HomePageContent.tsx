...
// promoUi: 'carousel' = current live homepage; 'grid' = the /promos rectangle
// cards (Richard 2026-08-23). /preview/home renders the grid variant so it can
// be reviewed at a real URL before the live homepage flips over.
export function HomePageContent({ promoUi = 'carousel' }: { promoUi?: 'carousel' | 'grid' }) {
