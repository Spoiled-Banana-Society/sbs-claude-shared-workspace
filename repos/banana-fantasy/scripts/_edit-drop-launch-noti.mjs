/**
 * EDIT the already-sent THE DROP launch bell in place.
 *
...
const TITLE = '🌙 Win a JACKHOF draft — THE DROP is live';
const MESSAGE = 'A JackHOF seat goes out EVERY night, guaranteed — plus a HOF seat and 15 free spins. Fill a draft to earn sealed packs (paid 2, free 1). They open at 8PM PT. The seat is in exactly one pack out of every pack earned that day, so the more you hold at 8PM the bigger your share of it.';
