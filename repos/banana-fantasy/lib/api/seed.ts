...
const seedPromos: Promo[] = [
  ...
  },
  {
    ...
    description: 'Friend buys passes → you get Free Spins at their 1st, 4th & 10th pass.',
    ctaText: 'Invite Now',
    ctaLink: '#',
    backgroundColor: '#2a2a35',
    claimable: false,
  ...
  },
  {
    ...
    description: 'Land your pick slot again using a paid draft to win Free Spins — the longer it takes, the bigger the payout.',
    ctaText: 'Start Drafting',
    ctaLink: '/drafting',
    backgroundColor: '#2a2a35',
    progressCurrent: 0,
  ...
  },
  {
    ...
    description: 'Jackpot just hit? Enter the Banana Zone — every filled paid draft earns Free Spins.',
    ctaText: 'Draft now',
    ctaLink: '/draft',
    backgroundColor: '#2a2a35',
    progressCurrent: 0,
