...
export const mockPromos: Promo[] = [
  ...
  },
  {
    id: 'founder-draft',
    type: 'founder-draft',
    title: 'Founder Draft → FREE DRAFT',
    description: 'Join a draft with the founder for a free draft',
    ctaText: 'View Drafts',
    ctaLink: '/standings',
    backgroundColor: '#2a2a35',
    progressCurrent: 0,
