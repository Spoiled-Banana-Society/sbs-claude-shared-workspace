...
const TITLE = 'Jackpot in the next 40 Drafts';
const MESSAGE = "Guess the exact Draft # the Jackpot hits — nail it and win 1 Free Spin.\nEnter with one reply on X. Tap to drop your guess.";
...
for (const wallet of wallets) {
  try {
    await db.collection('marketplace_notifications').doc(`${wallet}__jp-guess-0826`).create({
      wallet, type: 'promo', title: TITLE, message: MESSAGE,
      link: 'https://x.com/SBSFantasy/status/2092662873483059375',
      dedupeKey: 'jp-guess-0826', icon: '🎰', read: false,
