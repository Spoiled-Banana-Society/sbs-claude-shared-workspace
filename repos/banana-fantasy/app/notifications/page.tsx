                        ...
                        <div className="min-w-0">
                          <div className="flex items-center gap-2">
                            <p className={`text-sm font-semibold ${!notif.read ? 'text-white' : 'text-white/70'}`}>
                              {renderDynamicText(notif.title, notif as { dynamic?: string }, jpLeft, zoneLeft, zoneLeft2)}
                            </p>
                            <span
                          ...
                          <p className="text-white/40 text-xs mt-1 leading-relaxed whitespace-pre-line">{renderDynamicText(notif.message, notif as { dynamic?: string }, jpLeft, zoneLeft, zoneLeft2)}</p>
                        </div>
