/**
 * ⚠️ ONE-SHOT — bell notification blast announcing the 2026-08-17 2 PM ET Founder Draft w/ Justin Herzig (Boris).
 *
 * Writes one 'promo' notification per v2_users wallet so every user's header
 * bell lights up. Idempotent: doc id = `${wallet}__founder-justin-2026-08-17`
...
const NOTI = {
  type: 'promo',
  title: '👑 Founder Draft in 2 hours — with the legend Justin Herzig',
  message: 'Today at 2 PM ET. Enter with a paid draft and get a Free Spin. Tap for the post on X.',
