...
const seedPromos: Promo[] = [
  {
    ...
    modalContent: {
      ...
      totalPick10s: 8,
      pick10History: [
        { date: '2026-01-15', draftName: 'BBB League #1042', status: 'claim' },
        { date: '2026-01-14', draftName: 'BBB League #892', status: 'claim' },
        { date: '2026-01-12', draftName: 'BBB League #756', status: 'claimed' },
      ],
    },
  },
  {
