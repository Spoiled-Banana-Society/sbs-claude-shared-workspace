              ...
              <>
                ...
                {DEPOSITS_ENABLED && isLoggedIn && user && (
                  ...
                  >
                    ...
                    <span className="flex items-center justify-center w-[15px] h-[15px] rounded-full bg-banana text-white text-[11px] font-bold leading-none">+</span>
                  </button>
                )}
                  ...
                  {DEPOSITS_ENABLED && isLoggedIn && user && (
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="flex items-center justify-center w-4 h-4 rounded-full bg-banana text-white text-[11px] font-bold leading-none">+</span>
                      </button>
                    </Tooltip>
                  )}
