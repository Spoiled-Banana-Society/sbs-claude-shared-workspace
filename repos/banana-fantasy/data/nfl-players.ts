...
const TEAM_PLAYERS: Record<string, Record<string, string[]>> = {
  ...
  MIA: { QB: ['Tua Tagovailoa', 'Quinn Ewers', 'Zach Wilson'], RB1: ['De\'von Achane', 'Jaylen Wright', 'Ollie Gordon Ii'], RB2: ['Jaylen Wright', 'Ollie Gordon Ii', 'Donovan Edwards'], WR1: ['Tyreek Hill', 'Jaylen Waddle', 'Malik Washington'], WR2: ['Jaylen Waddle', 'Malik Washington', 'Cedrick Wilson Jr.'], TE: ['Julian Hill', 'Greg Dulcich', 'Darren Waller'], DST: ['MIA Defense'] },
  DAL: { QB: ['Dak Prescott', 'Joe Milton Iii'], RB1: ['Jaydon Blue', 'Phil Mafah', 'Javonte Williams'], RB2: ['Phil Mafah', 'Javonte Williams', 'Malik Davis'], WR1: ['Jalen Tolbert', 'KaVontae Turpin', 'Ryan Flournoy'], WR2: ['KaVontae Turpin', 'Ryan Flournoy', 'CeeDee Lamb'], TE: ['Jake Ferguson', 'Luke Schoonmaker', 'Brevyn Spann-ford'], DST: ['DAL Defense'] },
  ...
  BUF: { QB: ['Josh Allen', 'Mitchell Trubisky'], RB1: ['James Cook Iii', 'Ray Davis', 'Ty Johnson'], RB2: ['Ray Davis', 'Ty Johnson', 'Frank Gore'], WR1: ['Curtis Samuel', 'Khalil Shakir', 'Keon Coleman'], WR2: ['Khalil Shakir', 'Keon Coleman', 'Brandin Cooks'], TE: ['Dalton Kincaid', 'Dawson Knox', 'Jackson Hawes'], DST: ['BUF Defense'] },
  ...
  LAC: { QB: ['Justin Herbert', 'Trey Lance'], RB1: ['Kimani Vidal', 'Jaret Patterson', 'Omarion Hampton'], RB2: ['Jaret Patterson', 'Omarion Hampton', 'Hassan Haskins'], WR1: ['Ladd Mcconkey', 'Quentin Johnston', 'Keenan Allen'], WR2: ['Quentin Johnston', 'Keenan Allen', 'Tre Harris'], TE: ['Will Dissly', 'Oronde Gadsden Ii', 'Tucker Fisk'], DST: ['LAC Defense'] },
  SEA: { QB: ['Sam Darnold', 'Drew Lock', 'Jalen Milroe'], RB1: ['Kenneth Walker III', 'George Holani', 'Velus Jones Jr.'], RB2: ['George Holani', 'Velus Jones Jr.', 'Cam Akers'], WR1: ['Jaxon Smith-njigba', 'Jake Bobo', 'Cooper Kupp'], WR2: ['Jake Bobo', 'Cooper Kupp', 'Rashid Shaheed'], TE: ['Aj Barner', 'Elijah Arroyo', 'Eric Saubert'], DST: ['SEA Defense'] },
  ...
  NYJ: { QB: ['Tyrod Taylor', 'Brady Cook', 'Hendon Hooker'], RB1: ['Breece Hall', 'Khalil Herbert', 'Kene Nwangwu'], RB2: ['Khalil Herbert', 'Kene Nwangwu', 'Raheem Blackshear'], WR1: ['Garrett Wilson', 'John Metchie III', 'Adonai Mitchell'], WR2: ['John Metchie III', 'Adonai Mitchell', 'Isaiah Williams'], TE: ['Jeremy Ruckert', 'Stone Smartt', 'Jelani Woods'], DST: ['NYJ Defense'] },
  ...
  CHI: { QB: ['Caleb Williams', 'Tyson Bagent', 'Case Keenum'], RB1: ['D\'Andre Swift', 'Roschon Johnson', 'Travis Homer'], RB2: ['Roschon Johnson', 'Travis Homer', 'Kyle Monangai'], WR1: ['DJ Moore', 'Rome Odunze', 'Luther Burden Iii'], WR2: ['Rome Odunze', 'Luther Burden Iii', 'Olamide Zaccheaus'], TE: ['Cole Kmet', 'Colston Loveland', 'Durham Smythe'], DST: ['CHI Defense'] },
  PIT: { QB: ['Aaron Rodgers', 'Mason Rudolph', 'Will Howard'], RB1: ['Jaylen Warren', 'Kenneth Gainwell', 'Kaleb Johnson'], RB2: ['Kenneth Gainwell', 'Kaleb Johnson'], WR1: ['Roman Wilson', 'Calvin Austin III', 'D.K. Metcalf'], WR2: ['Calvin Austin III', 'D.K. Metcalf', 'Adam Thielen'], TE: ['Pat Freiermuth', 'Darnell Washington', 'Connor Heyward'], DST: ['PIT Defense'] },
  ...
  TEN: { QB: ['Will Levis', 'Jihad Ward', 'Brandon Allen'], RB1: ['Tony Pollard', 'Tyjae Spears', 'Julius Chestnut'], RB2: ['Tyjae Spears', 'Julius Chestnut', 'Kalel Mullings'], WR1: ['Calvin Ridley', 'Elic Ayomanor', 'Chimere Dike'], WR2: ['Elic Ayomanor', 'Chimere Dike', 'James Proche II'], TE: ['Chigoziem Okonkwo', 'Gunnar Helm', 'David Martin-robinson'], DST: ['TEN Defense'] },
