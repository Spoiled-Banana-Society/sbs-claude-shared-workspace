...
const depthChartData: { [key: string]: { name: string; status: 'starter' | 'backup' | 'injured'; projectedPoints: number }[] } = {
  ...
  'SEA-RB1': [{ name: 'Kenneth Walker', status: 'starter', projectedPoints: 10.9 }, { name: 'George Holani', status: 'backup', projectedPoints: 6.8 }, { name: 'Velus Jones Jr.', status: 'backup', projectedPoints: 2.5 }],
  ...
  'NYJ-WR1': [{ name: 'Garrett Wilson', status: 'starter', projectedPoints: 11.7 }, { name: 'John Metchie', status: 'backup', projectedPoints: 7.5 }, { name: 'Adonai Mitchell', status: 'backup', projectedPoints: 3.8 }],
  ...
  'PIT-WR1': [{ name: 'Roman Wilson', status: 'starter', projectedPoints: 9.0 }, { name: 'Calvin Austin', status: 'backup', projectedPoints: 5.8 }, { name: 'D.K. Metcalf', status: 'backup', projectedPoints: 4.2 }],
  'CHI-WR1': [{ name: 'DJ Moore', status: 'starter', projectedPoints: 8.6 }, { name: 'Rome Odunze', status: 'backup', projectedPoints: 6.2 }, { name: 'Luther Burden', status: 'backup', projectedPoints: 7.5 }],
  ...
  'NYJ-WR2': [{ name: 'John Metchie', status: 'starter', projectedPoints: 7.8 }, { name: 'Adonai Mitchell', status: 'backup', projectedPoints: 3.8 }, { name: 'Isaiah Williams', status: 'backup', projectedPoints: 2.2 }],
  ...
  'PIT-WR2': [{ name: 'Calvin Austin', status: 'starter', projectedPoints: 6.6 }, { name: 'D.K. Metcalf', status: 'backup', projectedPoints: 4.2 }, { name: 'Adam Thielen', status: 'backup', projectedPoints: 3.5 }],
  'CHI-WR2': [{ name: 'Rome Odunze', status: 'starter', projectedPoints: 6.2 }, { name: 'Luther Burden', status: 'backup', projectedPoints: 7.5 }, { name: 'Olamide Zaccheaus', status: 'backup', projectedPoints: 2.2 }],
  ...
  'TEN-WR2': [{ name: 'Elic Ayomanor', status: 'starter', projectedPoints: 4.3 }, { name: 'Chimere Dike', status: 'backup', projectedPoints: 3.5 }, { name: 'James Proche', status: 'injured', projectedPoints: 4.8 }],
  ...
  'LAC-TE': [{ name: 'Will Dissly', status: 'starter', projectedPoints: 2.3 }, { name: 'Oronde Gadsden', status: 'backup', projectedPoints: 2.8 }, { name: 'Tucker Fisk', status: 'backup', projectedPoints: 1.2 }],
