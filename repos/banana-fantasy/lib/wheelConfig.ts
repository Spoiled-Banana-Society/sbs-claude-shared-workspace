...
// JACKHOF WEDGE (planned, do NOT enable before draft 201 / rolling era):
// swap 'draft-1-e' → { id: 'jackhof', label: 'JackHOF', probability: 0.001,
// prizeType: 'custom', prizeValue: 'jackhof', color: '#ef6c37' } and set
// DRAFT_ONE = 0.8915 across 4 wedges. All jackhof plumbing (queue, notis,
// cards, spin route) is live and dormant — only this wedge gates it.
