        ...
        <div className="flex items-start gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            {identity.twitterHandle && (
              <a
                href={`https://x.com/${identity.twitterHandle}`}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-0.5 inline-flex items-center gap-1.5 text-sm font-medium text-sky-400 hover:text-sky-300"
                title={`Open @${identity.twitterHandle} on X`}
              >
