/**
 * ⚠️ ONE-SHOT — bell notification blast announcing Around The Banana ROUND THREE (Boris 2026-08-17).
 *
 * Writes one 'promo' notification per v2_users wallet so every user's header
 * bell lights up. Idempotent: doc id = `${wallet}__atb-round3-relaunch-2026-08-17`
...
const DEDUPE_KEY = 'atb-round3-relaunch-2026-08-17';
const ZERO = '0x0000000000000000000000000000000000000000';

const NOTI = {
  type: 'promo',
  title: '🍌 Around The Banana is back',
  message: 'First 10 players to hit all 10 pick slots win a Jackpot seat. Paid and free drafts both count.',
