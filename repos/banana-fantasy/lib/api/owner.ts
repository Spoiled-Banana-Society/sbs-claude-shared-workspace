...
export async function getOwnerUser(walletAddress: string): Promise<User> {
  ...
  console.log('[SBS DEBUG] getOwnerUser tokens total:', tokens.length, 'available:', availableTokens.length, 'availableCredit:', owner.availableCredit, 'apiUrl:', getDraftsApiUrl(), 'wallet:', normalizeWalletAddress(walletAddress));
