/**
 * ⚠️ ONE-SHOT — bell notification blast 50-minute reminder for the 2026-08-17 2 PM ET Founder Draft w/ Justin Herzig (Boris).
 *
 * Writes one 'promo' notification per v2_users wallet so every user's header
 * bell lights up. Idempotent: doc id = `${wallet}__founder-justin-50min-2026-08-17`
...
const DEDUPE_KEY = 'founder-justin-50min-2026-08-17';
const ZERO = '0x0000000000000000000000000000000000000000';

const NOTI = {
  type: 'promo',
  title: '👑 50 minutes till the streamed Founder Draft with Justin Herzig',
  message: '2 PM ET, live on X. Enter with a paid draft and you get a Free Spin. Tap for the post on X.',
  link: 'https://x.com/SBSFantasy/status/2089381773423808736?s=20',
