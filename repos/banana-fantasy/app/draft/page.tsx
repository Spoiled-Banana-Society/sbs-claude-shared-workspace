...
const INFO_TOPICS: Record<string, { title: string; items: { q: string; a: string }[] }> = {
  ...
  hof: {
    ...
    items: [
      ...
      { q: 'How do I get into a HOF Draft?', a: 'Two ways. 1) The reveal: every paid draft has a shot — when your room fills to 10, the slot machine reveals your type, and every 100 drafts contains exactly 5 HOF. 2) The Banana Wheel: land on HOF and you win a guaranteed seat in a HOF draft (from the Wheel), free.' },
  ...
  jackpot: {
    ...
    items: [
      ...
      { q: 'How do I get into a Jackpot Draft?', a: 'Two ways. 1) The reveal: every paid draft has a shot — when your room fills to 10, the slot machine reveals your type, and every 100 drafts contains exactly 1 Jackpot. 2) The Banana Wheel: land on Jackpot and you win a guaranteed seat in a Jackpot draft (from the Wheel), free.' },
